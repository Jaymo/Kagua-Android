...
public class FavAdapter extends BaseAdapter {
    ...
    public FavAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NAME.setText(hash.get(TestListFavFragmant.KEY_NAME));
        PHONE.setText(hash.get(TestListFavFragmant.KEY_PHONE));
        LAST_VISIT.setText(hash.get(TestListFavFragmant.KEY_LAST_VISIT));
        imageLoader.DisplayImage(hash.get(TestListFavFragmant.KEY_IMAGE_URL), thumb_image);
        return vi;
    }
