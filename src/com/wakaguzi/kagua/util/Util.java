...
/**
 * This is a utility class that has common methods to be used by most classes 
 * 
 * @author akajaymo
 */
public class Util {
	...
	/**
	 * Check if greater then HoneyComb
	 * 
